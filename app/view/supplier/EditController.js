Ext.define('POS.view.supplier.EditController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.edit-supplier',
    ...
    load: function(id){
        ...
        Ext.ws.Main.send('supplier/loadFormEdit', params);
    },
    ...
    save: function(){
        ...
        if(form.getForm().isValid()){
            ...
            Ext.ws.Main.send('supplier/update', values);
        }
    }
});
