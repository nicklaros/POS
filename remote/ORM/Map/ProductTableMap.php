...
class ProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ORM.Map.ProductTableMap';
     ...
     */
    const OM_CLASS = '\\ORM\\Product';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ORM.Product';
    ...
    {
        $this->addRelation('Stock', '\\ORM\\Stock', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), 'CASCADE', 'RESTRICT', 'Stocks');
    } // buildRelations()
    /**
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ORM\Product) { // it's a model object
