...
class CategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ORM.Map.CategoryTableMap';
     ...
     */
    const OM_CLASS = '\\ORM\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ORM.Category';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ORM\\Category');
        $this->setPackage('ORM');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ORM\Category) { // it's a model object
