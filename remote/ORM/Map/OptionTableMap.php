...
class OptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ORM.Map.OptionTableMap';
     ...
     */
    const OM_CLASS = '\\ORM\\Option';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ORM.Option';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserId', 'Name', 'Value', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'userId', 'name', 'value', ),
        self::TYPE_COLNAME       => array(OptionTableMap::COL_ID, OptionTableMap::COL_USER_ID, OptionTableMap::COL_NAME, OptionTableMap::COL_VALUE, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_USER_ID', 'COL_NAME', 'COL_VALUE', ),
        self::TYPE_FIELDNAME     => array('id', 'user_id', 'name', 'value', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserId' => 1, 'Name' => 2, 'Value' => 3, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'userId' => 1, 'name' => 2, 'value' => 3, ),
        self::TYPE_COLNAME       => array(OptionTableMap::COL_ID => 0, OptionTableMap::COL_USER_ID => 1, OptionTableMap::COL_NAME => 2, OptionTableMap::COL_VALUE => 3, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_USER_ID' => 1, 'COL_NAME' => 2, 'COL_VALUE' => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'user_id' => 1, 'name' => 2, 'value' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ORM\\Option');
        $this->setPackage('ORM');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('ID', 'Id', 'BIGINT', true, 20, null);
        $this->addColumn('USER_ID', 'UserId', 'BIGINT', true, 20, null);
        $this->addColumn('NAME', 'Name', 'CHAR', true, 128, null);
        $this->addColumn('VALUE', 'Value', 'CHAR', false, 128, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OptionTableMap::COL_NAME);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ORM\Option) { // it's a model object
