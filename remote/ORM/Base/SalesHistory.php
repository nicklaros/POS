...
use ORM\Map\SalesHistoryTableMap;
...
abstract class SalesHistory implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ORM\\Map\\SalesHistoryTableMap';
    ...
    /**
     * Initializes internal state of ORM\Base\SalesHistory object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SalesHistoryTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SalesHistoryTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SalesHistoryTableMap::translateFieldName('SalesId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sales_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SalesHistoryTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SalesHistoryTableMap::translateFieldName('Operation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->operation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SalesHistoryTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = SalesHistoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ORM\\SalesHistory'), 0, $e);
        }
    }
     ...
     * @return $this|\ORM\SalesHistory The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_USER_ID] = true;
        }
    ...
    public function setSalesId($v)
    {
        ...
        if ($this->sales_id !== $v) {
            $this->sales_id = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_SALES_ID] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            if ($dt !== $this->time) {
                $this->time = $dt;
                $this->modifiedColumns[SalesHistoryTableMap::COL_TIME] = true;
            }
    ...
    public function setOperation($v)
    {
        ...
        if ($this->operation !== $v) {
            $this->operation = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_OPERATION] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_DATA] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SalesHistoryTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SALES_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SALES_ID';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'TIME';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_OPERATION)) {
            $modifiedColumns[':p' . $index++]  = 'OPERATION';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_DATA)) {
            $modifiedColumns[':p' . $index++]  = 'DATA';
        }

        $sql = sprintf(
            'INSERT INTO sales_history (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['SalesHistory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SalesHistory'][$this->getPrimaryKey()] = true;
     ...
     *
     * @return $this|\ORM\SalesHistory The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SalesHistoryTableMap::COL_ID)) {
            $criteria->add(SalesHistoryTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_USER_ID)) {
            $criteria->add(SalesHistoryTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SALES_ID)) {
            $criteria->add(SalesHistoryTableMap::COL_SALES_ID, $this->sales_id);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TIME)) {
            $criteria->add(SalesHistoryTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_OPERATION)) {
            $criteria->add(SalesHistoryTableMap::COL_OPERATION, $this->operation);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_DATA)) {
            $criteria->add(SalesHistoryTableMap::COL_DATA, $this->data);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ORM\SalesHistory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ORM\SalesHistory Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUserDetail(ConnectionInterface $con = null)
    {
        if ($this->aUserDetail === null && (($this->user_id !== "" && $this->user_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserDetail->addSalesHistories($this);
             */
        }
