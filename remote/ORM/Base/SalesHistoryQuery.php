...
/**
 * Base class that represents a query for the 'sales_history' table.
 *
 *
 *
 ...
 * @method     ChildSalesHistoryQuery groupByData() Group by the data column
 *
 ...
 *
 * @method     ChildSalesHistoryQuery leftJoinUserDetail($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserDetail relation
 * @method     ChildSalesHistoryQuery rightJoinUserDetail($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserDetail relation
 * @method     ChildSalesHistoryQuery innerJoinUserDetail($relationAlias = null) Adds a INNER JOIN clause to the query using the UserDetail relation
 *
 * @method     ChildSalesHistoryQuery leftJoinSales($relationAlias = null) Adds a LEFT JOIN clause to the query using the Sales relation
 * @method     ChildSalesHistoryQuery rightJoinSales($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Sales relation
 * @method     ChildSalesHistoryQuery innerJoinSales($relationAlias = null) Adds a INNER JOIN clause to the query using the Sales relation
 *
 * @method     \ORM\UserDetailQuery|\ORM\SalesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildSalesHistory findOneByData(string $data) Return the first ChildSalesHistory filtered by the data column
 *
 ...
 * @method     ChildSalesHistory[]|ObjectCollection findByData(string $data) Return ChildSalesHistory objects filtered by the data column
...
abstract class SalesHistoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ORM\Base\SalesHistoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'pos', $modelName = '\\ORM\\SalesHistory', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SalesHistoryTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT ID, USER_ID, SALES_ID, TIME, OPERATION, DATA FROM sales_history WHERE ID = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SalesHistoryTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(SalesHistoryTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SalesHistoryTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(SalesHistoryTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(SalesHistoryTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SalesHistoryTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterBySalesId($salesId = null, $comparison = null)
    {
        if (is_array($salesId)) {
            ...
            if (isset($salesId['min'])) {
                $this->addUsingAlias(SalesHistoryTableMap::COL_SALES_ID, $salesId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($salesId['max'])) {
                $this->addUsingAlias(SalesHistoryTableMap::COL_SALES_ID, $salesId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SalesHistoryTableMap::COL_SALES_ID, $salesId, $comparison);
    }
    ...
    public function filterByOperation($operation = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SalesHistoryTableMap::COL_OPERATION, $operation, $comparison);
    }
    ...
    public function filterByData($data = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SalesHistoryTableMap::COL_DATA, $data, $comparison);
    }
    ...
    public function filterByUserDetail($userDetail, $comparison = null)
    {
        if ($userDetail instanceof \ORM\UserDetail) {
            return $this
                ->addUsingAlias(SalesHistoryTableMap::COL_USER_ID, $userDetail->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(SalesHistoryTableMap::COL_USER_ID, $userDetail->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterBySales($sales, $comparison = null)
    {
        if ($sales instanceof \ORM\Sales) {
            return $this
                ->addUsingAlias(SalesHistoryTableMap::COL_SALES_ID, $sales->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(SalesHistoryTableMap::COL_SALES_ID, $sales->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($salesHistory) {
            $this->addUsingAlias(SalesHistoryTableMap::COL_ID, $salesHistory->getId(), Criteria::NOT_EQUAL);
        }
