...
use \Exception;
use \PDO;
use ORM\CategoryQuery as ChildCategoryQuery;
use ORM\Map\CategoryTableMap;
...
abstract class Category implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ORM\\Map\\CategoryTableMap';
    ...
    /**
     * Initializes internal state of ORM\Base\Category object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ORM\\Category'), 0, $e);
        }
    }
     ...
     * @return $this|\ORM\Category The current object (for fluent API support)
     */
     ...
     *
     * @return $this|\ORM\Category The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ORM\Category (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ORM\Category Clone of current object.
     * @throws PropelException
     */
