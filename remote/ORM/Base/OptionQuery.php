...
use \Exception;
use \PDO;
use ORM\Option as ChildOption;
use ORM\OptionQuery as ChildOptionQuery;
use ORM\Map\OptionTableMap;
 ...
 * @method     ChildOptionQuery orderByName($order = Criteria::ASC) Order by the name column
 ...
 * @method     ChildOptionQuery groupByName() Group by the name column
 ...
 *
 * @method     ChildOption findOneById(string $id) Return the first ChildOption filtered by the id column
 * @method     ChildOption findOneByUserId(string $user_id) Return the first ChildOption filtered by the user_id column
 * @method     ChildOption findOneByName(string $name) Return the first ChildOption filtered by the name column
 ...
 * @method     ChildOption[]|ObjectCollection findById(string $id) Return ChildOption objects filtered by the id column
 * @method     ChildOption[]|ObjectCollection findByUserId(string $user_id) Return ChildOption objects filtered by the user_id column
 * @method     ChildOption[]|ObjectCollection findByName(string $name) Return ChildOption objects filtered by the name column
...
abstract class OptionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ORM\Base\OptionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'pos', $modelName = '\\ORM\\Option', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = OptionTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT ID, USER_ID, NAME, VALUE FROM option WHERE ID = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new ChildOption();
            $obj->hydrate($row);
            OptionTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(OptionTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(OptionTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(OptionTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(OptionTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OptionTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OptionTableMap::COL_NAME, $name, $comparison);
    }
    ...
    {
        if ($option) {
            $this->addUsingAlias(OptionTableMap::COL_ID, $option->getId(), Criteria::NOT_EQUAL);
        }
