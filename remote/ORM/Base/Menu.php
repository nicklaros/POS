...
abstract class Menu implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ORM\\Map\\MenuTableMap';
    ...
    /**
     * Initializes internal state of ORM\Base\Menu object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MenuTableMap::translateFieldName('Sub', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sub = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MenuTableMap::translateFieldName('Order', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MenuTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MenuTableMap::translateFieldName('Action', TableMap::TYPE_PHPNAME, $indexType)];
            $this->action = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : MenuTableMap::translateFieldName('State', TableMap::TYPE_PHPNAME, $indexType)];
            $this->state = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : MenuTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ORM\\Menu'), 0, $e);
        }
    }
     ...
     * @return $this|\ORM\Menu The current object (for fluent API support)
     */
    ...
    public function setSub($v)
    {
        ...
        if ($this->sub !== $v) {
            $this->sub = $v;
            $this->modifiedColumns[MenuTableMap::COL_SUB] = true;
        }
    ...
    public function setOrder($v)
    {
        ...
        if ($this->order !== $v) {
            $this->order = $v;
            $this->modifiedColumns[MenuTableMap::COL_ORDER] = true;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[MenuTableMap::COL_TEXT] = true;
        }
    ...
    public function setAction($v)
    {
        ...
        if ($this->action !== $v) {
            $this->action = $v;
            $this->modifiedColumns[MenuTableMap::COL_ACTION] = true;
        }
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[MenuTableMap::COL_STATE] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[MenuTableMap::COL_STATUS] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuTableMap::COL_SUB)) {
            $modifiedColumns[':p' . $index++]  = 'SUB';
        }
        if ($this->isColumnModified(MenuTableMap::COL_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER';
        }
        if ($this->isColumnModified(MenuTableMap::COL_ICON)) {
            $modifiedColumns[':p' . $index++]  = 'ICON';
        }
        if ($this->isColumnModified(MenuTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'TEXT';
        }
        if ($this->isColumnModified(MenuTableMap::COL_ACTION)) {
            $modifiedColumns[':p' . $index++]  = 'ACTION';
        }
        if ($this->isColumnModified(MenuTableMap::COL_STATE)) {
            $modifiedColumns[':p' . $index++]  = 'STATE';
        }
        if ($this->isColumnModified(MenuTableMap::COL_STATUS)) {
     ...
     *
     * @return $this|\ORM\Menu The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuTableMap::COL_SUB)) {
            $criteria->add(MenuTableMap::COL_SUB, $this->sub);
        }
        if ($this->isColumnModified(MenuTableMap::COL_ORDER)) {
            $criteria->add(MenuTableMap::COL_ORDER, $this->order);
        }
        if ($this->isColumnModified(MenuTableMap::COL_ICON)) {
            $criteria->add(MenuTableMap::COL_ICON, $this->icon);
        }
        if ($this->isColumnModified(MenuTableMap::COL_TEXT)) {
            $criteria->add(MenuTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(MenuTableMap::COL_ACTION)) {
            $criteria->add(MenuTableMap::COL_ACTION, $this->action);
        }
        if ($this->isColumnModified(MenuTableMap::COL_STATE)) {
            $criteria->add(MenuTableMap::COL_STATE, $this->state);
        }
        if ($this->isColumnModified(MenuTableMap::COL_STATUS)) {
            $criteria->add(MenuTableMap::COL_STATUS, $this->status);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ORM\Menu (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ORM\Menu Clone of current object.
     * @throws PropelException
     */
