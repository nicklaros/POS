 ...
 * @method     ChildCustomerQuery orderByRegisteredDate($order = Criteria::ASC) Order by the registered_date column
 ...
 * @method     ChildCustomerQuery groupByRegisteredDate() Group by the registered_date column
 ...
 *
 * @method     ChildCustomerQuery leftJoinSales($relationAlias = null) Adds a LEFT JOIN clause to the query using the Sales relation
 * @method     ChildCustomerQuery rightJoinSales($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Sales relation
 * @method     ChildCustomerQuery innerJoinSales($relationAlias = null) Adds a INNER JOIN clause to the query using the Sales relation
 *
 * @method     \ORM\SalesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildCustomer findOneById(string $id) Return the first ChildCustomer filtered by the id column
 * @method     ChildCustomer findOneByRegisteredDate(string $registered_date) Return the first ChildCustomer filtered by the registered_date column
 ...
 * @method     ChildCustomer findOneByStatus(string $status) Return the first ChildCustomer filtered by the status column
 *
 ...
 * @method     ChildCustomer[]|ObjectCollection findById(string $id) Return ChildCustomer objects filtered by the id column
 * @method     ChildCustomer[]|ObjectCollection findByRegisteredDate(string $registered_date) Return ChildCustomer objects filtered by the registered_date column
 ...
 * @method     ChildCustomer[]|ObjectCollection findByBirthday(string $birthday) Return ChildCustomer objects filtered by the birthday column
 ...
 * @method     ChildCustomer[]|ObjectCollection findByStatus(string $status) Return ChildCustomer objects filtered by the status column
...
abstract class CustomerQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ORM\Base\CustomerQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'pos', $modelName = '\\ORM\\Customer', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT ID, REGISTERED_DATE, NAME, ADDRESS, BIRTHDAY, GENDER, PHONE, STATUS FROM customer WHERE ID = :p0';
        try {
    ...
    public function filterByRegisteredDate($registeredDate = null, $comparison = null)
    {
        if (is_array($registeredDate)) {
            ...
            if (isset($registeredDate['min'])) {
                $this->addUsingAlias(CustomerTableMap::COL_REGISTERED_DATE, $registeredDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($registeredDate['max'])) {
                $this->addUsingAlias(CustomerTableMap::COL_REGISTERED_DATE, $registeredDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CustomerTableMap::COL_REGISTERED_DATE, $registeredDate, $comparison);
    }
    ...
    public function filterByBirthday($birthday = null, $comparison = null)
    {
        if (is_array($birthday)) {
            ...
            if (isset($birthday['min'])) {
                $this->addUsingAlias(CustomerTableMap::COL_BIRTHDAY, $birthday['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($birthday['max'])) {
                $this->addUsingAlias(CustomerTableMap::COL_BIRTHDAY, $birthday['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CustomerTableMap::COL_BIRTHDAY, $birthday, $comparison);
    }
    ...
    public function filterBySales($sales, $comparison = null)
    {
        if ($sales instanceof \ORM\Sales) {
            return $this
                ->addUsingAlias(CustomerTableMap::COL_ID, $sales->getCustomerId(), $comparison);
