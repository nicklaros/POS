...
abstract class PurchaseHistory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ORM\\Map\\PurchaseHistoryTableMap';
    ...
    /**
     * Initializes internal state of ORM\Base\PurchaseHistory object.
     */
    ...
    /**
     * Compares this with another <code>PurchaseHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>PurchaseHistory</code>, delegates to
     * <code>equals(PurchaseHistory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PurchaseHistory The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PurchaseHistoryTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PurchaseHistoryTableMap::translateFieldName('Operation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->operation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PurchaseHistoryTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = PurchaseHistoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ORM\\PurchaseHistory'), 0, $e);
        }
    }
    ...
    {
        if ($this->aUserDetail !== null && $this->user_id !== $this->aUserDetail->getId()) {
            $this->aUserDetail = null;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PurchaseHistoryTableMap::COL_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[PurchaseHistoryTableMap::COL_USER_ID] = true;
        }

        if ($this->aUserDetail !== null && $this->aUserDetail->getId() !== $v) {
            $this->aUserDetail = null;
        }
    ...
    public function setPurchaseId($v)
    {
        ...
        if ($this->purchase_id !== $v) {
            $this->purchase_id = $v;
            $this->modifiedColumns[PurchaseHistoryTableMap::COL_PURCHASE_ID] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            if ($dt !== $this->time) {
                $this->time = $dt;
                $this->modifiedColumns[PurchaseHistoryTableMap::COL_TIME] = true;
            }
    ...
    public function setOperation($v)
    {
        ...
        if ($this->operation !== $v) {
            $this->operation = $v;
            $this->modifiedColumns[PurchaseHistoryTableMap::COL_OPERATION] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[PurchaseHistoryTableMap::COL_DATA] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPurchaseHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPurchaseHistoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PurchaseHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aUserDetail !== null) {
                if ($this->aUserDetail->isModified() || $this->aUserDetail->isNew()) {
                    $affectedRows += $this->aUserDetail->save($con);
                }
                $this->setUserDetail($this->aUserDetail);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'USER_ID';
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_PURCHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PURCHASE_ID';
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'TIME';
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_OPERATION)) {
            $modifiedColumns[':p' . $index++]  = 'OPERATION';
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_DATA)) {
            $modifiedColumns[':p' . $index++]  = 'DATA';
        }

        $sql = sprintf(
            'INSERT INTO purchase_history (%s) VALUES (%s)',
    ...
    {
        $pos = PurchaseHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PurchaseHistory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PurchaseHistory'][$this->getPrimaryKey()] = true;
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aUserDetail) {
                $result['UserDetail'] = $this->aUserDetail->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ORM\PurchaseHistory
     */
     ...
     *
     * @return $this|\ORM\PurchaseHistory The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_ID)) {
            $criteria->add(PurchaseHistoryTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_USER_ID)) {
            $criteria->add(PurchaseHistoryTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_PURCHASE_ID)) {
            $criteria->add(PurchaseHistoryTableMap::COL_PURCHASE_ID, $this->purchase_id);
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_TIME)) {
            $criteria->add(PurchaseHistoryTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_OPERATION)) {
            $criteria->add(PurchaseHistoryTableMap::COL_OPERATION, $this->operation);
        }
        if ($this->isColumnModified(PurchaseHistoryTableMap::COL_DATA)) {
            $criteria->add(PurchaseHistoryTableMap::COL_DATA, $this->data);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ORM\PurchaseHistory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ORM\PurchaseHistory Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUserDetail(ConnectionInterface $con = null)
    {
        if ($this->aUserDetail === null && (($this->user_id !== "" && $this->user_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserDetail->addPurchaseHistories($this);
             */
        }
    ...
    public function getPurchase(ConnectionInterface $con = null)
    {
        if ($this->aPurchase === null && (($this->purchase_id !== "" && $this->purchase_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPurchase->addHistories($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PurchaseHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
